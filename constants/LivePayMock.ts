...
export const ledger: LedgerEntry[] = [
  {
    ...
    category: 'Browsing & Search',
    intent: 'Visited: amazon.com',
    status: 'CLAIMED',
    buyer: 'Realtime Stream',
    saleUsd: 0.05,
    userSplitUsd: 0.04,
    meshSplitUsd: 0.01,
    source: 'amazon.com',
  ...
  {
    id: 'l2',
    timestamp: '2026-01-30T11:55:00Z',
    category: 'Browsing & Search',
    intent: 'Query: best laptop under 1000',
    status: 'CLAIMED',
    buyer: 'Realtime Stream',
    saleUsd: 0.03,
    userSplitUsd: 0.03,
    meshSplitUsd: 0.00,
    source: 'best laptop under 1000',
    hash: '0x2ac1…44d0',
  },
  {
    id: 'l3',
